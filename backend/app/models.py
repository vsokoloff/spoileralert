...
# SQLite compatibility: use String instead of Enum for SQLite
# PostgreSQL can use Enum, but SQLite doesn't support it
...
class DeletedItem(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id"), nullable=False)
    original_data = Column(Text)  # JSON string of original item data
