...
import { X, ChevronRight, ChevronLeft, Camera, FileText, Bell, Sparkles, Tags, Trash2, Filter, Apple, Palette } from 'lucide-react'
...
const STEPS = [
  ...
  },
  {
    ...
    tip: 'Tip:Works best with clear, flat receipts in good lighting.',
  },
  {
    ...
    tip: 'Tip:You can always override the filled-in values.',
  },
  {
    ...
    tip: 'Tip:Items are sorted by expiration by default so red ones bubble up.',
  },
  {
    icon: <Filter size={32} />,
    ...
    tip: 'Tip:Filter by "Expiring Soon" to quickly see what needs eating.',
  },
  {
    ...
    tip: 'Tip:SPOY opens with automatic suggestions every time you visit.',
  },
  {
    icon: <Tags size={32} />,
    ...
    tip: 'Tip:Try "Sarah", "Everyone", or "Mine" as tags.',
  },
  {
    icon: <Bell size={32} />,
    title: 'Notifications',
    ...
    tip: 'Tip:Daily digest at noon keeps you on top of expiring items.',
  },
  {
    icon: <Trash2 size={32} />,
    title: 'Undo Deletes',
    ...
    tip: 'Tip:Items are kept for 24 hours before being permanently removed.',
  },
]
